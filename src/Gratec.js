...
import { ChevronLeft, ChevronRight, PlayCircle, Star, BookOpen, Film, Twitter, Instagram, Linkedin, Users, Award, Smile } from 'lucide-react';
...
const testimonials = [
  {
    ...
    quote: "This course is a game-changer. I went from zero to building professional client websites in weeks. The 8-hour video is pure gold!",
    stars: 5,
    type: 'text',
  },
  {
    name: "Michael B.",
    role: "Entrepreneur",
    quote: "I wanted to build my own e-commerce site without hiring a dev. GRATEC gave me the confidence and skills. Highly recommended.",
    stars: 5,
    type: 'text',
  },
  {
    ...
    videoUrl: "https://videos.pexels.com/video-files/857251/857251-hd_1280_720_25fps.mp4",
    thumbnail: `https://images.pexels.com/photos/196655/pexels-photo-196655.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1`,
    type: 'video',
  },
  {
    name: "Emily R.",
    role: "Marketing Manager",
    quote: "The clarity and depth of the content are unparalleled. I can now manage my company's WordPress site with ease.",
    stars: 5,
    type: 'text',
  },
    {
    name: "David Chen",
    role: "Student",
    videoUrl: "https://videos.pexels.com/video-files/854251/854251-hd_1280_720_30fps.mp4",
...
const Header = () => (
  <header className="fixed top-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-md">
    <div className="container mx-auto px-6 py-4 flex justify-between items-center">
      <h1 className="text-3xl font-bold text-gray-900 tracking-tighter">GRATEC Course</h1>
      <a href="#purchase" className="bg-yellow-400 text-gray-900 font-bold py-2 px-6 rounded-full hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105">
        Get The Course
      </a>
    </div>
  </header>
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    {/* UPDATED: aspect-video ensures 16:9 ratio for the thumbnail */}
                    <div className="relative aspect-video">
                         <img 
                            src="gratecbanner2.png" 
                            alt="WordPress Foundation Course Banner" 
                            className="w-full h-full object-cover"
                            onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/1280x720/333/FFF?text=Foundation+Course'; }}
                        />
                    ...
                    <div className="p-8">
                        ...
                        <p className="mt-3 text-gray-600">Master the WordPress dashboard, themes, plugins, and build your first complete website from scratch.</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div className="relative aspect-video">
                        <img 
                            src="gratecbanner3.png" 
                            alt="WordPress Pro Toolkit Course Banner" 
                            className="w-full h-full object-cover"
                            onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/1280x720/111/FFF?text=Pro+Toolkit+Course'; }}
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                    ...
                    <div className="p-8">
                        ...
                        <p className="mt-3 text-gray-600">Dive deep into custom post types, advanced plugins, e-commerce, and client management strategies.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="reviews" className="bg-white py-20 overflow-hidden">
      <div className="container mx-auto">
        <div className="px-6 text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Don't just take our word for it. See what our students have built and hear their stories.</p>
        </div>

        <div className="relative mt-12">
            <div 
                ref={scrollContainerRef}
                className="flex overflow-x-auto snap-x snap-mandatory scroll-smooth pb-8 reviews-scrollbar"
            >
                    ...
                    {testimonials.map((item, index) => (
                        <div key={index} className="snap-start shrink-0 w-[85vw] md:w-[450px] mr-6">
                            {item.type === 'text' ? (
                                ...
                                <div 
                                    className="relative bg-black rounded-3xl h-full flex flex-col justify-end text-white overflow-hidden cursor-pointer group shadow-lg"
                                ...
                                >
                                    <img 
                                      ...
                                      onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/600x400/000/FFF?text=Video+Review'; }}
                                    />
             ...
             <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between px-2 md:px-8 pointer-events-none">
                <button 
                    onClick={() => scroll(-1)} 
                    className="pointer-events-auto bg-white/80 backdrop-blur-sm rounded-full p-2 shadow-lg hover:bg-white transition-all duration-300"
    ...
    <section id="purchase" className="py-20 bg-yellow-400">
        <div className="container mx-auto px-6 text-center">
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-16 max-w-4xl mx-auto">
                ...
                <button className="bg-gray-900 text-white font-bold py-4 px-12 rounded-full text-lg hover:bg-black transition-all duration-300 transform hover:scale-105 w-full md:w-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul className="mt-4 space-y-3">
                        <li><a href="#purchase" className="text-gray-400 hover:text-yellow-400 transition-colors">Courses</a></li>
                        <li><a href="#reviews" className="text-gray-400 hover:text-yellow-400 transition-colors">Reviews</a></li>
                ...
                <div>
                    ...
                    <ul className="mt-4 space-y-3">
                        <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors">Success Stories</a></li>
                        <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors">Our Graduates</a></li>
                        <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors">Affiliate Program</a></li>
                    </ul>
                </div>
                ...
                <div className="bg-gray-800 p-6 rounded-2xl">
                    ...
                    <p className="mt-3 text-gray-400 text-sm">See what our graduates are earning as freelance WordPress developers.</p>
                    <div className="mt-4">
...
export default function Gratec() {
  return (
    <div className="bg-white font-sans">
      ...
      <main>
        <HeroSection />
        {/* ADDED THE NEW STATS SECTION HERE */}
        <StatsSection />
        <CourseBanner />
        <ReviewsSection />
        <PurchaseSection />
